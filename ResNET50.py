...
def ResNet50(input_shape=(64, 64, 1), classes=7):
...
model = ResNet50(input_shape=(64,64,1), classes = 7)
...
checkpoint = ModelCheckpoint("resNet50_Weights.h5", monitor='val_accuracy',
