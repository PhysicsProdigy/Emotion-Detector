...
def ResNet101(input_shape=(64, 64, 1), classes=7):
...
model = ResNet101(input_shape=(64,64,1), classes = 7)
...
checkpoint = ModelCheckpoint("resNet101_Weights.h5", monitor='val_accuracy',
...
with open("resNet101.json", "w") as json_file:
